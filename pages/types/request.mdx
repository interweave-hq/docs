...
Fields _not_ specified in the URL will be appended as query parameters. For example, a key of `location` will be appended as ?location=value

| Type                            | Required |     Default |
| :------------------------------ | :------: | ----------: |
| [Fields](/specification/fields) |    No    | `undefined` |
