...
Interweave doesn't require the JavaScript or the npm package to function. You can make a regular HTTP request to the Interweave API to build your interface with JSON.
